...
## between Jelly and Control in first incubation
################################################
...
J_C_COG20_enr <- read.csv(paste0(wd,"09_METABOLISM/COG20/Jelly_control_COG20_FUN_enrichment.txt"),
                      sep = "\t") %>% select(-c("key")) %>% 
...
J_C_CAZy_enr <- read.csv(paste0(wd,"09_METABOLISM/CAZy/Jelly_control_CAZy_enrichment.txt"),
...
##############################################
#import enrichment results
SJ_SC_Prot_enr <- read.csv(paste0(wd,"09_METABOLISM/MEROPS/Jelly_control_MEROPS_enrichment.txt"),
                           sep = "\t") %>% 
...
#Alphaproteobacteria
ggsave(paste0("Figures/J_vs_C_enr_pathway_Alpha.png"),
...
#Bacteroidia
ggsave(paste0("Figures/J_vs_C_enr_pathway_Bac.png"),
...
#Gammaproteobacteria
ggsave(paste0("Figures/J_vs_C_enr_pathway_Gamma.png"),
